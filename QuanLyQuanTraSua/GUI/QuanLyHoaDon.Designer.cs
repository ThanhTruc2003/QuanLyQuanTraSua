namespace QuanLyQuanTraSua.GUI
{
	partial class FormQuanLyHoaDon
	{
		...
		private void InitializeComponent()
		{
			...
			dgvHoaDon.Location = new Point(-1, 87);
			dgvHoaDon.Name = "dgvHoaDon";
			dgvHoaDon.RowHeadersWidth = 51;
			dgvHoaDon.RowTemplate.Height = 29;
			dgvHoaDon.Size = new Size(1238, 340);
			...
			lbDanhSachNV.Location = new Point(-1, 43);
			...
			// buttonXemChiTiet
			// 
			buttonXemChiTiet.Location = new Point(1056, 445);
			buttonXemChiTiet.Name = "buttonXemChiTiet";
			buttonXemChiTiet.Size = new Size(171, 29);
